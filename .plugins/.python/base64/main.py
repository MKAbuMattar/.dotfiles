...
# -*- coding: utf-8 -*-
#---------------------------------------------------------------------------------------------------
# MKAbuMattar's Profile - Base64 Plugin
#
#
#                             .
#         ..                .''
...
Usage:
    ...
    python3 main.py --decode "SGVsbG8gV29ybGQ="
    python3 main.py --encode-file myfile.txt
    python3 main.py --decode-file encoded.txt
"""
...
def encode_text(text: str, verbose: bool = False) -> str:
    """
...
def decode_text(text: str, verbose: bool = False) -> str:
    """
...
def encode_file(file_path: str, output_path: str | None = None, verbose: bool = False) -> str:
    """
    ...
    try:
        ...
        # Write output
        Path(output_path).write_text(base64_string)
...
def decode_file(file_path: str, output_path: str | None = None, verbose: bool = False) -> str:
    """
    ...
    try:
        ...
        # Read file
        base64_string = src.read_text().strip()
