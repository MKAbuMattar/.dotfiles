...
# -*- coding: utf-8 -*-
#---------------------------------------------------------------------------------------------------
# MKAbuMattar's Profile - PrayerTimes Plugin
#
#
#                             .
#         ..                .''
...
Usage:
    python3 main.py --city <city> --country <country> [--method <method>] [--format 24]
"""
...
def get_prayer_times(city: str, country: str, method: int = 1, use_24_hour_format: bool = False) -> None:
...
def main() -> int:
    """Parse CLI args and print prayer times for the given city/country."""
