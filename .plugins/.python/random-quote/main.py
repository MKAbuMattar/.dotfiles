...
# -*- coding: utf-8 -*-
#---------------------------------------------------------------------------------------------------
# MKAbuMattar's Profile - RandomQuote Plugin
#
#
#                             .
#         ..                .''
...
def get_random_quote(verbose: bool = False) -> dict:
    """
...
def display_quote_default(quote_data: dict) -> None:
...
def display_quote_simple(quote_data: dict) -> None:
...
def display_quote_json(quote_data: dict) -> None:
